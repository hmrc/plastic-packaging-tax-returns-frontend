...
object SubscriptionUpdateRequest {
  ...
  def apply(subscriptionDisplayResponse: SubscriptionDisplayResponse): SubscriptionUpdateRequest =
    SubscriptionUpdateRequest(
      ...
      businessCorrespondenceDetails = subscriptionDisplayResponse.businessCorrespondenceDetails,
      ...
      groupSubscription = subscriptionDisplayResponse.groupSubscription
    )
