...
object ManufacturedPlasticWeight extends CommonFormValidators {
  ...
  val weightEmptyError      = "manufacturedPlasticWeight.empty.error"
  val invalidFormatError    = "manufacturedPlasticWeight.format.error"
  val aboveMaxError         = "manufacturedPlasticWeight.aboveMax.error"
  val invalidValueError     = "manufacturedPlasticWeight.invalidValue.error"
