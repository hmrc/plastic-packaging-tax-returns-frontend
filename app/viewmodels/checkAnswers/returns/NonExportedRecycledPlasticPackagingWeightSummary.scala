...
class NonExportedRecycledPlasticPackagingWeightSummary(key: String = "NonExportRecycledPlasticPackagingWeight.checkYourAnswersLabel")
  ...
  override def answer(answers: UserAnswers): Option[Long] = {
    answers.get(NonExportedRecycledPlasticPackagingWeightPage)
  }
}
