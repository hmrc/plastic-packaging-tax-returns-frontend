...
import pages.returns.{ConvertedPackagingCreditPage, ExportedPlasticPackagingWeightPage, HumanMedicinesPlasticPackagingWeightPage, ImportedPlasticPackagingPage, ImportedPlasticPackagingWeightPage, ManufacturedPlasticPackagingPage, ManufacturedPlasticPackagingWeightPage, NonExportRecycledPlasticPackagingWeightPage}
    ...
    returnType match {
      case NEW =>
        TaxReturn(id = pptReference,
          ...
          recycledPlasticWeight = userAnswers.get(NonExportRecycledPlasticPackagingWeightPage).map(
