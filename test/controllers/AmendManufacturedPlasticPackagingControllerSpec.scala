...
class AmendManufacturedPlasticPackagingControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val amendManufacturedPlasticPackagingRoute = routes.AmendManufacturedPlasticPackagingController.onPageLoad(NormalMode).url
  ...
  "AmendManufacturedPlasticPackaging Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AmendManufacturedPlasticPackagingPage, validAnswer).success.value
