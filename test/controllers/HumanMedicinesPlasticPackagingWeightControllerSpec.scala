...
class HumanMedicinesPlasticPackagingWeightControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val humanMedicinesPlasticPackagingWeightRoute = routes.HumanMedicinesPlasticPackagingWeightController.onPageLoad(NormalMode).url
  ...
  "HumanMedicinesPlasticPackagingWeight Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(HumanMedicinesPlasticPackagingWeightPage, validAnswer).success.value
