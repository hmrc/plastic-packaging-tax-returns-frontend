...
class ImportedPlasticPackagingWeightControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val importedPlasticPackagingWeightRoute = routes.ImportedPlasticPackagingWeightController.onPageLoad(NormalMode).url
  ...
  "ImportedPlasticPackagingWeight Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ImportedPlasticPackagingWeightPage, validAnswer).success.value
