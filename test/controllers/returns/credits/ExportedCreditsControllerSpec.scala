...
//
//      running(application) {
//        val request = FakeRequest(GET, exportedCreditsRoute)
//
//        val result = route(application, request).value
//
//        val view = application.injector.instanceOf[ExportedCreditsView]
//
...
//
//      //val userAnswers = UserAnswers(userAnswersId).set(ExportedCreditsPage, true).success.value
//
...
//      running(application) {
//        val request =
//          FakeRequest(POST, exportedCreditsRoute)
//            .withFormUrlEncodedBody(("value", "true"))
//
//        val result = route(application, request).value
//
//        status(result) mustEqual SEE_OTHER
//        redirectLocation(result).value mustEqual controllers.returns.credits.routes.ConvertedCreditsController.onPageLoad(NormalMode).url
//      }
//    }
//
