...
class ConvertedPackagingCreditControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val convertedPackagingCreditRoute = routes.ConvertedPackagingCreditController.onPageLoad(NormalMode).url
  ...
  "ConvertedPackagingCredit Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ConvertedPackagingCreditPage, validAnswer).success.value
