...
class ImportedPlasticPackagingControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val importedPlasticPackagingRoute = routes.ImportedPlasticPackagingController.onPageLoad(NormalMode).url
  ...
  "ImportedPlasticPackaging Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ImportedPlasticPackagingPage, true).success.value
