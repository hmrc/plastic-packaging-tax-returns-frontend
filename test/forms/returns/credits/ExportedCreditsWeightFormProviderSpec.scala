...
class ExportedCreditsWeightFormProviderSpec extends LongFieldBehaviours {

  private val form: Form[Long] = new ExportedCreditsWeightFormProvider().apply()
  ...
  ".value" - {
    ...
    behave like mandatoryField(
      form,
      fieldName,
      requiredError = FormError(fieldName, "exportedCreditsWeight.error.required")
    )
  }
}
