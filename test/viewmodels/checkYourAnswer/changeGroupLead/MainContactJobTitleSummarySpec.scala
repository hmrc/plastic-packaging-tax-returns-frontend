...
import viewmodels.checkAnswers.changeGroupLead.MainContactJobTitleSummary
import viewmodels.govuk.summarylist._

class MainContactJobTitleSummarySpec extends PlaySpec {
  ...
  "summary" should {
    "return a row" in {
      ...
      when(message.apply("newGroupLeadCheckYourAnswers.job.title.key")).thenReturn("[KEY]")
