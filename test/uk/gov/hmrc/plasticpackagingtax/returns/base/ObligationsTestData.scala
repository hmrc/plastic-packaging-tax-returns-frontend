...
object ObligationsTestData {
  ...
  val noneDueUpToDate = PPTObligations(nextObligation = None,
  ...
  val oneDueUpToDate = PPTObligations(nextObligation = Some(aDueObligation()),
                                      oldestOverdueObligation = None,
                                      overdueObligationCount = 0,
  ...
  val oneDueOneOverdue = PPTObligations(nextObligation = Some(aDueObligation()),
  ...
  val oneDueTwoOverdue = PPTObligations(nextObligation = Some(aDueObligation()),
                                        oldestOverdueObligation = Some(anOverdueObligation()),
  ...
  private def aDueObligation() = {
    ...
    Obligation(fromDate = periodStartDate,
