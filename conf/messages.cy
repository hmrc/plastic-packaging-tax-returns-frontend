...
newGroupLeadEnterContactAddress.heading = What is {0}’s contact address?
newGroupLeadEnterContactAddress.paragraph = We’ll only use this to send information about the group’s Plastic Packaging Tax account and returns.
newGroupLeadEnterContactAddress.addressLine1.label = Address line 1
newGroupLeadEnterContactAddress.addressLine2.label = Address line 2
...
mainContactJobTitle.title = What is the main contact’s job title?
mainContactJobTitle.heading = What is {0}’s job title?
